...
namespace Mizore.CommunicationHandler.Data.Params
{
    ...
    /// </summary>
    public static class SpellingParams
    {
        ...
        /// </summary>
        public const string SPELLCHECK_ALTERNATIVE_TERM_COUNT = SPELLCHECK_PREFIX + "alternativeTermCount";
        ...
        /// </summary>
        public const string SPELLCHECK_MAX_RESULTS_FOR_SUGGEST = SPELLCHECK_PREFIX + "maxResultsForSuggest";
        ...
        /// </summary>
        public const string SPELLCHECK_COLLATE_MAX_COLLECT_DOCS = SPELLCHECK_PREFIX + "collateMaxCollectDocs";
        ...
        /// </summary>
        public const string SPELLCHECK_COLLATE_PARAM_OVERRIDE = SPELLCHECK_PREFIX + "collateParam.";
